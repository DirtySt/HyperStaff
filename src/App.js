    ...
    render(){
        return (
            <div className={"wrapper"}>
                ...
                <Items onShowItem={this.onShowItem} items={this.state.currentItems} onAdd={this.addToOrders}/>
                {this.state.showFullItem && <ShowFullItem item={this.state.fullItem} onAdd={this.addToOrders} onShowItem={this.onShowItem}/>}
                <Footer/>
            </div>
        );
    }
